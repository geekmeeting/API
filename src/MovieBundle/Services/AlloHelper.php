<?php
    ...
    use MovieBundle\Services\AlloImage;
    ...
    */
    ...
    class AlloHelper
    {
         ...
         * CONSTANTE
         */
        const ALLO_THROW_EXCEPTIONS = true;
        const ALLOCINE_SECRET_KEY = '29d185d98c984a359e6e6f26a0474269';
        const ALLO_UTF8_DECODE = true;
        const ALLO_AUTO_CORRECT_APOSTROPHES = true;
        const ALLO_PARTNER = '100043982026';
        const ALLO_DEFAULT_URL_API = 'api.allocine.fr';
        const ALLO_DEFAULT_URL_IMAGES = 'images.allocine.fr';
         ...
         */
        protected $throwExceptions = self::ALLO_THROW_EXCEPTIONS;

        /**
         * @var string Clé secrète
         */
        protected $allocineSecretKey = self::ALLOCINE_SECRET_KEY;

        /**
         * @var bool Flag pour activer le decodage UTF8
         */
        protected $utf8Decode = self::ALLO_UTF8_DECODE;

        /**
         * @var bool Flag pour corriger les apostrophes
         */
        protected $autoCorrectApostrophe = self::ALLO_AUTO_CORRECT_APOSTROPHES;

        /**
         * @var string Le partenaire utilisé pour toutes les requêtes.
         */
        protected $partner = self::ALLO_PARTNER;

        /**
         * Contient l'adresse du site où chercher les données.
         * @var string
         */
        protected $APIUrl = self::ALLO_DEFAULT_URL_API;

        /**
         * Contient l'adresse du site où chercher les images.
         * @var string
         */
        protected $imagesUrl = self::ALLO_DEFAULT_URL_IMAGES;
